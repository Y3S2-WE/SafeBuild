...
### Frontend File Structure (Phase 1)
...
- `POST /api/users/login` (shared login portal)
- `GET /api/users/profile` (session hydration)
...
Change the URL if backend runs on another host/port.
